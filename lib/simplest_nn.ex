defmodule SimplestNN do
  ...
  # After the neuron finishes setting its s_pid and a_pid to that of the senor and actuator respectively, it starts waiting for the incoming signals.  The neuron expects a vector of length 2 as input, and as soon as the input arrives, the neuron processes the signal and passes the output vector to the outgoing a_pid
